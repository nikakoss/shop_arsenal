...
class ControllerPaymentPayanywayAlfaclick extends Controller {
	...
	public function index() {
		...
		$this->data['action'] = $this->url->link('payment/payanyway_alfaclick', 'token=' . $this->session->data['token'], 'SSL');
		...
		if (isset($this->request->post['payanyway_alfaclick_status'])) {
			$this->data['payanyway_alfaclick_status'] = $this->request->post['payanyway_alfaclick_status'];
		} else {
			$this->data['payanyway_alfaclick_status'] = $this->config->get('payanyway_alfaclick_status');
		}

		if (isset($this->request->post['payanyway_alfaclick_sort_order'])) {
			$this->data['payanyway_alfaclick_sort_order'] = $this->request->post['payanyway_alfaclick_sort_order'];
		} else {
			$this->data['payanyway_alfaclick_sort_order'] = $this->config->get('payanyway_alfaclick_sort_order');
		}

		$this->template = 'payment/payanyway_alfaclick.tpl';
		$this->children = array(
			'common/header',
			'common/footer',
		);
