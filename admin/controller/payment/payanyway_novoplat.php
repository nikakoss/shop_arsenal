...
class ControllerPaymentPayanywayNovoplat extends Controller {
	...
	public function index() { 
		...
		$this->data['action'] = $this->url->link('payment/payanyway_novoplat', 'token=' . $this->session->data['token'], 'SSL');
		...
		if (isset($this->request->post['payanyway_novoplat_status'])) {
			$this->data['payanyway_novoplat_status'] = $this->request->post['payanyway_novoplat_status'];
		} else {
			$this->data['payanyway_novoplat_status'] = $this->config->get('payanyway_novoplat_status');
		}

		if (isset($this->request->post['payanyway_novoplat_sort_order'])) {
			$this->data['payanyway_novoplat_sort_order'] = $this->request->post['payanyway_novoplat_sort_order'];
		} else {
			$this->data['payanyway_novoplat_sort_order'] = $this->config->get('payanyway_novoplat_sort_order');
		}

		$this->template = 'payment/payanyway_novoplat.tpl';
		$this->children = array(
			'common/header',
			'common/footer',
		);
