...
class ControllerPaymentPayanywayMoneta extends Controller {
	...
	public function index() {
		...
		$this->data['action'] = $this->url->link('payment/payanyway_moneta', 'token=' . $this->session->data['token'], 'SSL');
		...
		if (isset($this->request->post['payanyway_moneta_status'])) {
			$this->data['payanyway_moneta_status'] = $this->request->post['payanyway_moneta_status'];
		} else {
			$this->data['payanyway_moneta_status'] = $this->config->get('payanyway_moneta_status');
		}

		if (isset($this->request->post['payanyway_moneta_sort_order'])) {
			$this->data['payanyway_moneta_sort_order'] = $this->request->post['payanyway_moneta_sort_order'];
		} else {
			$this->data['payanyway_moneta_sort_order'] = $this->config->get('payanyway_moneta_sort_order');
		}

		$this->template = 'payment/payanyway_moneta.tpl';
		$this->children = array(
			'common/header',
			'common/footer',
		);
