...
class ControllerPaymentPayanywaySberbank extends Controller {
	...
	public function index() { 
		...
		$this->data['action'] = $this->url->link('payment/payanyway_sberbank', 'token=' . $this->session->data['token'], 'SSL');
		...
		if (isset($this->request->post['payanyway_sberbank_status'])) {
			$this->data['payanyway_sberbank_status'] = $this->request->post['payanyway_sberbank_status'];
		} else {
			$this->data['payanyway_sberbank_status'] = $this->config->get('payanyway_sberbank_status');
		}

		if (isset($this->request->post['payanyway_sberbank_sort_order'])) {
			$this->data['payanyway_sberbank_sort_order'] = $this->request->post['payanyway_sberbank_sort_order'];
		} else {
			$this->data['payanyway_sberbank_sort_order'] = $this->config->get('payanyway_sberbank_sort_order');
		}

		$this->template = 'payment/payanyway_sberbank.tpl';
		$this->children = array(
			'common/header',
			'common/footer',
		);
