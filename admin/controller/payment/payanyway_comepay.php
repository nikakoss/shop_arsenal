...
class ControllerPaymentPayanywayComepay extends Controller {
	...
	public function index() {
		...
		$this->data['action'] = $this->url->link('payment/payanyway_comepay', 'token=' . $this->session->data['token'], 'SSL');
		...
		if (isset($this->request->post['payanyway_comepay_status'])) {
			$this->data['payanyway_comepay_status'] = $this->request->post['payanyway_comepay_status'];
		} else {
			$this->data['payanyway_comepay_status'] = $this->config->get('payanyway_comepay_status');
		}

		if (isset($this->request->post['payanyway_comepay_sort_order'])) {
			$this->data['payanyway_comepay_sort_order'] = $this->request->post['payanyway_comepay_sort_order'];
		} else {
			$this->data['payanyway_comepay_sort_order'] = $this->config->get('payanyway_comepay_sort_order');
		}

		$this->template = 'payment/payanyway_comepay.tpl';
		$this->children = array(
			'common/header',
			'common/footer',
		);
