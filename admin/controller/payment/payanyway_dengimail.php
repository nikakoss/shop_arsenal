...
class ControllerPaymentPayanywayDengimail extends Controller {
	...
	public function index() { 
		...
		$this->data['action'] = $this->url->link('payment/payanyway_dengimail', 'token=' . $this->session->data['token'], 'SSL');
		...
		if (isset($this->request->post['payanyway_dengimail_status'])) {
			$this->data['payanyway_dengimail_status'] = $this->request->post['payanyway_dengimail_status'];
		} else {
			$this->data['payanyway_dengimail_status'] = $this->config->get('payanyway_dengimail_status');
		}

		if (isset($this->request->post['payanyway_dengimail_sort_order'])) {
			$this->data['payanyway_dengimail_sort_order'] = $this->request->post['payanyway_dengimail_sort_order'];
		} else {
			$this->data['payanyway_dengimail_sort_order'] = $this->config->get('payanyway_dengimail_sort_order');
		}

		$this->template = 'payment/payanyway_dengimail.tpl';
		$this->children = array(
			'common/header',
			'common/footer',
		);
