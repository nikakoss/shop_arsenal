...
class ControllerPaymentPayanywayFaktura extends Controller {
	...
	public function index() {
		...
		$this->data['action'] = $this->url->link('payment/payanyway_faktura', 'token=' . $this->session->data['token'], 'SSL');
		...
		if (isset($this->request->post['payanyway_faktura_status'])) {
			$this->data['payanyway_faktura_status'] = $this->request->post['payanyway_faktura_status'];
		} else {
			$this->data['payanyway_faktura_status'] = $this->config->get('payanyway_faktura_status');
		}

		if (isset($this->request->post['payanyway_faktura_sort_order'])) {
			$this->data['payanyway_faktura_sort_order'] = $this->request->post['payanyway_faktura_sort_order'];
		} else {
			$this->data['payanyway_faktura_sort_order'] = $this->config->get('payanyway_faktura_sort_order');
		}

		$this->template = 'payment/payanyway_faktura.tpl';
		$this->children = array(
			'common/header',
			'common/footer',
		);
