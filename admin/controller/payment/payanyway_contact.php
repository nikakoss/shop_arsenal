...
class ControllerPaymentPayanywayContact extends Controller {
	...
	public function index() {
		...
		$this->data['action'] = $this->url->link('payment/payanyway_contact', 'token=' . $this->session->data['token'], 'SSL');
		...
		if (isset($this->request->post['payanyway_contact_status'])) {
			$this->data['payanyway_contact_status'] = $this->request->post['payanyway_contact_status'];
		} else {
			$this->data['payanyway_contact_status'] = $this->config->get('payanyway_contact_status');
		}

		if (isset($this->request->post['payanyway_contact_sort_order'])) {
			$this->data['payanyway_contact_sort_order'] = $this->request->post['payanyway_contact_sort_order'];
		} else {
			$this->data['payanyway_contact_sort_order'] = $this->config->get('payanyway_contact_sort_order');
		}

		$this->template = 'payment/payanyway_contact.tpl';
		$this->children = array(
			'common/header',
			'common/footer',
		);
