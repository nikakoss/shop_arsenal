...
class ControllerPaymentPayanywayPCard extends Controller {
	...
	public function index() { 
		...
		$this->data['action'] = $this->url->link('payment/payanyway_pcard', 'token=' . $this->session->data['token'], 'SSL');
		...
		if (isset($this->request->post['payanyway_pcard_status'])) {
			$this->data['payanyway_pcard_status'] = $this->request->post['payanyway_pcard_status'];
		} else {
			$this->data['payanyway_pcard_status'] = $this->config->get('payanyway_pcard_status');
		}

		if (isset($this->request->post['payanyway_pcard_sort_order'])) {
			$this->data['payanyway_pcard_sort_order'] = $this->request->post['payanyway_pcard_sort_order'];
		} else {
			$this->data['payanyway_pcard_sort_order'] = $this->config->get('payanyway_pcard_sort_order');
		}

		$this->template = 'payment/payanyway_pcard.tpl';
		$this->children = array(
			'common/header',
			'common/footer',
		);
