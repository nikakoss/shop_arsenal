...
class ControllerPaymentPayanywayEuroset extends Controller {
	...
	public function index() { 
		...
		$this->data['action'] = $this->url->link('payment/payanyway_euroset', 'token=' . $this->session->data['token'], 'SSL');
		...
		if (isset($this->request->post['payanyway_euroset_status'])) {
			$this->data['payanyway_euroset_status'] = $this->request->post['payanyway_euroset_status'];
		} else {
			$this->data['payanyway_euroset_status'] = $this->config->get('payanyway_euroset_status');
		}

		if (isset($this->request->post['payanyway_euroset_sort_order'])) {
			$this->data['payanyway_euroset_sort_order'] = $this->request->post['payanyway_euroset_sort_order'];
		} else {
			$this->data['payanyway_euroset_sort_order'] = $this->config->get('payanyway_euroset_sort_order');
		}

		$this->template = 'payment/payanyway_euroset.tpl';
		$this->children = array(
			'common/header',
			'common/footer',
		);
