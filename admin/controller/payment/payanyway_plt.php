...
class ControllerPaymentPayanywayPLT extends Controller {
	...
	public function index() { 
		...
		$this->data['action'] = $this->url->link('payment/payanyway_plt', 'token=' . $this->session->data['token'], 'SSL');
		...
		if (isset($this->request->post['payanyway_plt_status'])) {
			$this->data['payanyway_plt_status'] = $this->request->post['payanyway_plt_status'];
		} else {
			$this->data['payanyway_plt_status'] = $this->config->get('payanyway_plt_status');
		}

		if (isset($this->request->post['payanyway_plt_sort_order'])) {
			$this->data['payanyway_plt_sort_order'] = $this->request->post['payanyway_plt_sort_order'];
		} else {
			$this->data['payanyway_plt_sort_order'] = $this->config->get('payanyway_plt_sort_order');
		}

		$this->template = 'payment/payanyway_plt.tpl';
		$this->children = array(
			'common/header',
			'common/footer',
		);
