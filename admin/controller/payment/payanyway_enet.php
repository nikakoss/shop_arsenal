...
class ControllerPaymentPayanywayENet extends Controller {
	...
	public function index() { 
		...
		$this->data['action'] = $this->url->link('payment/payanyway_enet', 'token=' . $this->session->data['token'], 'SSL');
		...
		if (isset($this->request->post['payanyway_enet_status'])) {
			$this->data['payanyway_enet_status'] = $this->request->post['payanyway_enet_status'];
		} else {
			$this->data['payanyway_enet_status'] = $this->config->get('payanyway_enet_status');
		}

		if (isset($this->request->post['payanyway_enet_sort_order'])) {
			$this->data['payanyway_enet_sort_order'] = $this->request->post['payanyway_enet_sort_order'];
		} else {
			$this->data['payanyway_enet_sort_order'] = $this->config->get('payanyway_enet_sort_order');
		}

		$this->template = 'payment/payanyway_enet.tpl';
		$this->children = array(
			'common/header',
			'common/footer',
		);
