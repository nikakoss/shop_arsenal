...
class ControllerPaymentPayanywayFM extends Controller {
	...
	public function index() { 
		...
		$this->data['action'] = $this->url->link('payment/payanyway_fm', 'token=' . $this->session->data['token'], 'SSL');
		...
		if (isset($this->request->post['payanyway_fm_status'])) {
			$this->data['payanyway_fm_status'] = $this->request->post['payanyway_fm_status'];
		} else {
			$this->data['payanyway_fm_status'] = $this->config->get('payanyway_fm_status');
		}

		if (isset($this->request->post['payanyway_fm_sort_order'])) {
			$this->data['payanyway_fm_sort_order'] = $this->request->post['payanyway_fm_sort_order'];
		} else {
			$this->data['payanyway_fm_sort_order'] = $this->config->get('payanyway_fm_sort_order');
		}

		$this->template = 'payment/payanyway_fm.tpl';
		$this->children = array(
			'common/header',
			'common/footer',
		);
