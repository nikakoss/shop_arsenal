...
class ControllerPaymentPayanywayQiwi extends Controller {
	...
	public function index() { 
		...
		$this->data['action'] = $this->url->link('payment/payanyway_qiwi', 'token=' . $this->session->data['token'], 'SSL');
		...
		if (isset($this->request->post['payanyway_qiwi_status'])) {
			$this->data['payanyway_qiwi_status'] = $this->request->post['payanyway_qiwi_status'];
		} else {
			$this->data['payanyway_qiwi_status'] = $this->config->get('payanyway_qiwi_status');
		}

		if (isset($this->request->post['payanyway_qiwi_sort_order'])) {
			$this->data['payanyway_qiwi_sort_order'] = $this->request->post['payanyway_qiwi_sort_order'];
		} else {
			$this->data['payanyway_qiwi_sort_order'] = $this->config->get('payanyway_qiwi_sort_order');
		}

		$this->template = 'payment/payanyway_qiwi.tpl';
		$this->children = array(
			'common/header',
			'common/footer',
		);
