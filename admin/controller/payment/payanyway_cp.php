...
class ControllerPaymentPayanywayCP extends Controller {
	...
	public function index() {
		...
		$this->data['action'] = $this->url->link('payment/payanyway_cp', 'token=' . $this->session->data['token'], 'SSL');
		...
		if (isset($this->request->post['payanyway_cp_status'])) {
			$this->data['payanyway_cp_status'] = $this->request->post['payanyway_cp_status'];
		} else {
			$this->data['payanyway_cp_status'] = $this->config->get('payanyway_cp_status');
		}

		if (isset($this->request->post['payanyway_cp_sort_order'])) {
			$this->data['payanyway_cp_sort_order'] = $this->request->post['payanyway_cp_sort_order'];
		} else {
			$this->data['payanyway_cp_sort_order'] = $this->config->get('payanyway_cp_sort_order');
		}

		$this->template = 'payment/payanyway_cp.tpl';
		$this->children = array(
			'common/header',
			'common/footer',
		);
