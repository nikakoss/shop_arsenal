...
class ControllerPaymentPayanywayMKB extends Controller {
	...
	public function index() { 
		...
		$this->data['action'] = $this->url->link('payment/payanyway_mkb', 'token=' . $this->session->data['token'], 'SSL');
		...
		if (isset($this->request->post['payanyway_mkb_status'])) {
			$this->data['payanyway_mkb_status'] = $this->request->post['payanyway_mkb_status'];
		} else {
			$this->data['payanyway_mkb_status'] = $this->config->get('payanyway_mkb_status');
		}

		if (isset($this->request->post['payanyway_mkb_sort_order'])) {
			$this->data['payanyway_mkb_sort_order'] = $this->request->post['payanyway_mkb_sort_order'];
		} else {
			$this->data['payanyway_mkb_sort_order'] = $this->config->get('payanyway_mkb_sort_order');
		}

		$this->template = 'payment/payanyway_mkb.tpl';
		$this->children = array(
			'common/header',
			'common/footer',
		);
