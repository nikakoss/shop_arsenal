...
class ControllerPaymentPayanywayYM extends Controller {
	...
	public function index() {
		...
		$this->data['action'] = $this->url->link('payment/payanyway_ym', 'token=' . $this->session->data['token'], 'SSL');
		...
		if (isset($this->request->post['payanyway_ym_status'])) {
			$this->data['payanyway_ym_status'] = $this->request->post['payanyway_ym_status'];
		} else {
			$this->data['payanyway_ym_status'] = $this->config->get('payanyway_ym_status');
		}

		if (isset($this->request->post['payanyway_ym_sort_order'])) {
			$this->data['payanyway_ym_sort_order'] = $this->request->post['payanyway_ym_sort_order'];
		} else {
			$this->data['payanyway_ym_sort_order'] = $this->config->get('payanyway_ym_sort_order');
		}

		$this->template = 'payment/payanyway_ym.tpl';
		$this->children = array(
			'common/header',
			'common/footer',
		);
