...
class ControllerPaymentPayanywayWM extends Controller {
	...
	public function index() { 
		...
		$this->data['action'] = $this->url->link('payment/payanyway_wm', 'token=' . $this->session->data['token'], 'SSL');
		...
		if (isset($this->request->post['payanyway_wm_status'])) {
			$this->data['payanyway_wm_status'] = $this->request->post['payanyway_wm_status'];
		} else {
			$this->data['payanyway_wm_status'] = $this->config->get('payanyway_wm_status');
		}

		if (isset($this->request->post['payanyway_wm_sort_order'])) {
			$this->data['payanyway_wm_sort_order'] = $this->request->post['payanyway_wm_sort_order'];
		} else {
			$this->data['payanyway_wm_sort_order'] = $this->config->get('payanyway_wm_sort_order');
		}

		$this->template = 'payment/payanyway_wm.tpl';
		$this->children = array(
			'common/header',
			'common/footer',
		);
