...
class ControllerPaymentPayanywayCity extends Controller {
	...
	public function index() { 
		...
		$this->data['action'] = $this->url->link('payment/payanyway_city', 'token=' . $this->session->data['token'], 'SSL');
		...
		if (isset($this->request->post['payanyway_city_status'])) {
			$this->data['payanyway_city_status'] = $this->request->post['payanyway_city_status'];
		} else {
			$this->data['payanyway_city_status'] = $this->config->get('payanyway_city_status');
		}

		if (isset($this->request->post['payanyway_city_sort_order'])) {
			$this->data['payanyway_city_sort_order'] = $this->request->post['payanyway_city_sort_order'];
		} else {
			$this->data['payanyway_city_sort_order'] = $this->config->get('payanyway_city_sort_order');
		}

		$this->template = 'payment/payanyway_city.tpl';
		$this->children = array(
			'common/header',
			'common/footer',
		);
