...
class ControllerPaymentPayanywayBanktransfer extends Controller {
	...
	public function index() {
		...
		$this->data['action'] = $this->url->link('payment/payanyway_banktransfer', 'token=' . $this->session->data['token'], 'SSL');
		...
		if (isset($this->request->post['payanyway_banktransfer_status'])) {
			$this->data['payanyway_banktransfer_status'] = $this->request->post['payanyway_banktransfer_status'];
		} else {
			$this->data['payanyway_banktransfer_status'] = $this->config->get('payanyway_banktransfer_status');
		}

		if (isset($this->request->post['payanyway_banktransfer_sort_order'])) {
			$this->data['payanyway_banktransfer_sort_order'] = $this->request->post['payanyway_banktransfer_sort_order'];
		} else {
			$this->data['payanyway_banktransfer_sort_order'] = $this->config->get('payanyway_banktransfer_sort_order');
		}

		$this->template = 'payment/payanyway_banktransfer.tpl';
		$this->children = array(
			'common/header',
			'common/footer',
		);
