...
class ControllerPaymentPayanywayPost extends Controller {
	...
	public function index() { 
		...
		$this->data['action'] = $this->url->link('payment/payanyway_post', 'token=' . $this->session->data['token'], 'SSL');
		...
		if (isset($this->request->post['payanyway_post_status'])) {
			$this->data['payanyway_post_status'] = $this->request->post['payanyway_post_status'];
		} else {
			$this->data['payanyway_post_status'] = $this->config->get('payanyway_post_status');
		}

		if (isset($this->request->post['payanyway_post_sort_order'])) {
			$this->data['payanyway_post_sort_order'] = $this->request->post['payanyway_post_sort_order'];
		} else {
			$this->data['payanyway_post_sort_order'] = $this->config->get('payanyway_post_sort_order');
		}

		$this->template = 'payment/payanyway_post.tpl';
		$this->children = array(
			'common/header',
			'common/footer',
		);
