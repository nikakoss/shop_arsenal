...
class ControllerModuleSimple extends Controller {
    ...
    public function index() {
        ...
        $address_fields = array('main_firstname','main_lastname','main_company','main_company_id','main_tax_id','main_address_1','main_address_2','main_city','main_postcode','main_zone_id','main_country_id','main_telephone');
