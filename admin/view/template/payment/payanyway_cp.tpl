      ...
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
        <table class="form">
          ...
          <tr>
            ...
            <td><select name="payanyway_cp[payanyway_cp_status]">
          ...
          <tr>
            ...
            <td><input type="text" name="payanyway_cp[payanyway_cp_sort_order]" value="<?php echo $payanyway_cp_sort_order; ?>" size="1" /></td>
          </tr>
        </table>
      </form>
    </div>
