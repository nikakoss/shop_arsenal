      ...
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
        <table class="form">
          ...
          <tr>
            ...
            <td><select name="moneta[payanyway_status]">
          ...
          <tr>
            ...
            <td><input type="text" name="moneta[payanyway_sort_order]" value="<?php echo $payanyway_sort_order; ?>" size="1" /></td>
          </tr>
          <tr>
            <td><?php echo $entry_username; ?></td>
            <td><input type="text" name="moneta[payanyway_username]" value="<?php echo $payanyway_username; ?>" /></td>
          </tr>
          <tr>
            <td><?php echo $entry_password; ?></td>
            <td><input type="text" name="moneta[payanyway_password]" value="<?php echo $payanyway_password; ?>" /></td>
          </tr>
        </table>
      </form>
    </div>
