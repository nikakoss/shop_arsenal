      ...
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
        <table class="form">
          ...
          <tr>
            ...
            <td><select name="payanyway_contact[payanyway_contact_status]">
          ...
          <tr>
            ...
            <td><input type="text" name="payanyway_contact[payanyway_contact_sort_order]" value="<?php echo $payanyway_contact_sort_order; ?>" size="1" /></td>
          </tr>
        </table>
      </form>
    </div>
