      ...
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
        <table class="form">
          ...
          <tr>
            ...
            <td><select name="payanyway_sberbank[payanyway_sberbank_status]">
          ...
          <tr>
            ...
            <td><input type="text" name="payanyway_sberbank[payanyway_sberbank_sort_order]" value="<?php echo $payanyway_sberbank_sort_order; ?>" size="1" /></td>
          </tr>
        </table>
      </form>
    </div>
