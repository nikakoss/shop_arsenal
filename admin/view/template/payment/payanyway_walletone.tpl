      ...
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
        <table class="form">
          ...
          <tr>
            ...
            <td><select name="payanyway_walletone[payanyway_walletone_status]">
          ...
          <tr>
            ...
            <td><input type="text" name="payanyway_walletone[payanyway_walletone_sort_order]" value="<?php echo $payanyway_walletone_sort_order; ?>" size="1" /></td>
          </tr>
        </table>
      </form>
    </div>
