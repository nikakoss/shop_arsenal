	...
	<tr>
      ...
      <table id="module" class="list">
        ...
        <tbody id="module-row<?php echo $module_row; ?>">
          <tr>
            <td class="left"><select name="recall2_module[<?php echo $module_row; ?>][layout_id]">
            ...
            <td class="left"><select name="recall2_module[<?php echo $module_row; ?>][position]">
            ...
            <td class="left"><select name="recall2_module[<?php echo $module_row; ?>][status]">
            ...
            <td class="right"><input type="text" name="recall2_module[<?php echo $module_row; ?>][sort_order]" value="<?php echo $module['sort_order']; ?>" size="3" /></td>
...
function addModule() {
	...
	html += '  <tr>';
	html += '    <td class="left"><select name="recall2_module[' + module_row + '][layout_id]">';
	<?php foreach ($layouts as $layout) { ?>
	html += '      <option value="<?php echo $layout['layout_id']; ?>"><?php echo $layout['name']; ?></option>';
	<?php } ?>
	html += '    </select></td>';
	html += '    <td class="left"><select name="recall2_module[' + module_row + '][position]">';
	html += '      <option value="content_top"><?php echo $text_content_top; ?></option>';
	html += '      <option value="content_bottom"><?php echo $text_content_bottom; ?></option>';
	html += '      <option value="column_left"><?php echo $text_column_left; ?></option>';
	html += '      <option value="column_right"><?php echo $text_column_right; ?></option>';
	html += '    </select></td>';
	html += '    <td class="left"><select name="recall2_module[' + module_row + '][status]">';
    html += '      <option value="1" selected="selected"><?php echo $text_enabled; ?></option>';
    html += '      <option value="0"><?php echo $text_disabled; ?></option>';
    html += '    </select></td>';
	html += '    <td class="right"><input type="text" name="recall2_module[' + module_row + '][sort_order]" value="" size="3" /></td>';
