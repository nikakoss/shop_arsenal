...
public function getOrderTotalSum($order_id) {
		$query = $this->db->query("SELECT total, customer_group_id, payment_code, firstname, lastname  FROM " . DB_PREFIX . "order WHERE order_id = '" . (int)$order_id . "'");
