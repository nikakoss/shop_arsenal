    ...
    <div class="box-content filterpro">
        <form id="filterpro">
            ...
            <div class="open_block clearfix">
                <div class="option_name" onclick="hideBlock('hideBlock')"><a href="javascript:void(0);" class="zaglavie active-zagl"><span><?php echo $text_manufacturers; ?></span></a></div>
                ...
                <div class="input-block clear" id="hideBlock">
                    <?php foreach($manufacturers as $manufacturer) { ?>
                    <ul>
                        <li>    
                            <input id="manufacturer_<?php echo $manufacturer['manufacturer_id']?>" class="manufacturer_value filtered clearCheckInputValue"
            ...
            <div class="price_slider  open_block clearfix" <?php if(!$price_slider) { echo 'style="display:none"';}?>>
                 <div class="option_name" style="background-image: none;"><a href="javascript:void(0);" onclick="hideBlock('priceBlock')" class="zaglavie active-zagl"><span>Цена:</span></a></div>
                <div class="clear-open_block"><a href="javascript:void(0);" onclick="clearPrice()"> Очистить поле </a></div>
                <div class="cost-block clear" id="priceBlock">
...
<div class="kat_act clearfix"><a onclick="btn_category_list()">Категории товаров</a></div>
<?php if($tags || $categories || $options || $manufacturers || $attributes || $price_slider) { ?>
<div class="box">
