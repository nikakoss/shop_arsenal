 ...
 if ($records) {
 ?>
<div class="news_article latest-info" id="cmswidget-<?php echo $cmswidget; ?>">
 <h2><?php echo $heading_title; ?></h2>
	...
	<img alt="<?php echo $images['title']; ?>" title="<?php echo $images['title']; ?>" src="<?php echo $images['thumb']; ?>">
      ...
      <?php } ?>
      <?php } ?>
	<div class="opisanie_news latest-information">
    ...
    <?php } ?>
					    ...
					    <a href="<?php echo $record['blog_href']; ?>">Все статьи</a>
					    <?php } ?>
					    <?php
					    //	}
					    ?>
