...
$(function () {
    ...
    $('.rating-sort').click(function(event){
       event.preventDefault();
        // reset
        $('.review-sort').removeClass('active asc desc');  
        $('.price-sort').removeClass('active asc desc');  
        $('#filterpro_sort').val('rating'); 
       if($(this).hasClass('asc')){
           $(this).removeClass('asc').addClass('desc');
            $('#filterpro_order').val('DESC');
        ...
        $("#filterpro .primenit").trigger("click");
    });
    
    $('.price-sort').click(function(event){
       event.preventDefault();
        // reset
        $('.rating-sort').removeClass('active asc desc');  
        $('.review-sort').removeClass('active asc desc');        
        $('#filterpro_sort').val('p.price');        
       if($(this).hasClass('asc')){
           $(this).removeClass('asc').addClass('desc');
           $('#filterpro_order').val('DESC');
       }else if($(this).hasClass('desc')){
    ...
    $('.review-sort').click(function(event){
       event.preventDefault();
       // reset
        $('.rating-sort').removeClass('active asc desc');  
        $('.price-sort').removeClass('active asc desc');  
          $('#filterpro_sort').val('p.viewed');
...
function select_total(){
   // console.log( );    
    $('#filterpro_limit').val(parseInt($('.filter-total-page select').val()));
     $("#filterpro .primenit").trigger("click");
}
...
$(document).ready(function () {
    ...
    $(".pagination div ul li a").live("click", (function (e) {
        e.preventDefault();
     ...
     $(".pred").live("click", (function (e) {
        e.preventDefault();
        var a = $('#filterpro_page').val();
        var b = parseInt(a)-1;
