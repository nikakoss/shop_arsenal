...
class ControllerModuleRecall2 extends Controller {
	...
	protected function index() {
		$this->language->load('module/recall2');
    	...
    	$this->data['text_recall2'] = $this->language->get('text_recall2');
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/module/recall2.tpl')) {
			$this->template = $this->config->get('config_template') . '/template/module/recall2.tpl';
		} else {
			$this->template = 'default/template/module/recall2.tpl';
		}
