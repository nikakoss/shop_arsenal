...
class ControllerPaymentPayanywayCP extends Controller {
	protected function index() {
		...
		$this->data['paymentSystemUnitId'] = 489755;
		$this->data['paymentSystemAccountId'] = 19357960;
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/payment/payanyway_cp.tpl')) {
			$this->template = $this->config->get('config_template') . '/template/payment/payanyway_cp.tpl';
		} else {
			$this->template = 'default/template/payment/payanyway_cp.tpl';
		}
