...
class ControllerPaymentPayanywayWalletone extends Controller {
	protected function index() {
		...
		$this->data['paymentSystemUnitId'] = 310212;
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/payment/payanyway_walletone.tpl')) {
			$this->template = $this->config->get('config_template') . '/template/payment/payanyway_walletone.tpl';
		} else {
			$this->template = 'default/template/payment/payanyway_walletone.tpl';
		}	
