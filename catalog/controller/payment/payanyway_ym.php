...
class ControllerPaymentPayanywayYM extends Controller {
	protected function index() {
		...
		$this->data['paymentSystemUnitId'] = 1020;
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/payment/payanyway_ym.tpl')) {
			$this->template = $this->config->get('config_template') . '/template/payment/payanyway_ym.tpl';
		} else {
			$this->template = 'default/template/payment/payanyway_ym.tpl';
		}	
