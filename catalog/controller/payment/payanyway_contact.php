...
class ControllerPaymentPayanywayContact extends Controller {
	protected function index() {
		...
		$this->data['paymentSystemUnitId'] = 1028;
		$this->data['paymentSystemAccountId'] = 26;
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/payment/payanyway_contact.tpl')) {
			$this->template = $this->config->get('config_template') . '/template/payment/payanyway_contact.tpl';
		} else {
			$this->template = 'default/template/payment/payanyway_contact.tpl';
		}
