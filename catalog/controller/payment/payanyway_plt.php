...
class ControllerPaymentPayanywayPLT extends Controller {
	protected function index() {
		...
		$this->data['paymentSystemUnitId'] = 226272;
		$this->data['paymentSystemAccountId'] = 15662295;
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/payment/payanyway_plt.tpl')) {
			$this->template = $this->config->get('config_template') . '/template/payment/payanyway_plt.tpl';
		} else {
			$this->template = 'default/template/payment/payanyway_plt.tpl';
		}	
