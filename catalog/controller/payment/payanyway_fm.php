...
class ControllerPaymentPayanywayFM extends Controller {
	protected function index() {
		...
		$this->data['paymentSystemUnitId'] = 83046;
		$this->data['paymentSystemAccountId'] = 116;
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/payment/payanyway_fm.tpl')) {
			$this->template = $this->config->get('config_template') . '/template/payment/payanyway_fm.tpl';
		} else {
			$this->template = 'default/template/payment/payanyway_fm.tpl';
		}	
