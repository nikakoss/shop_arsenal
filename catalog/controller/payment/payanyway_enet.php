...
class ControllerPaymentPayanywayENet extends Controller {
	protected function index() {
		...
		$this->data['paymentSystemUnitId'] = 232821;
		$this->data['paymentSystemAccountId'] = 10496472;
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/payment/payanyway_enet.tpl')) {
			$this->template = $this->config->get('config_template') . '/template/payment/payanyway_enet.tpl';
		} else {
			$this->template = 'default/template/payment/payanyway_enet.tpl';
		}	
