...
class ControllerPaymentPayanywayFaktura extends Controller {
	protected function index() {
		...
		$this->data['paymentSystemUnitId'] = 609111;
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/payment/payanyway_faktura.tpl')) {
			$this->template = $this->config->get('config_template') . '/template/payment/payanyway_faktura.tpl';
		} else {
			$this->template = 'default/template/payment/payanyway_faktura.tpl';
		}	
