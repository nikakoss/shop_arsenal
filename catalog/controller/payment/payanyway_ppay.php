...
class ControllerPaymentPayanywayPPay extends Controller {
	protected function index() {
		...
		$this->data['paymentSystemUnitId'] = 281390;
		$this->data['paymentSystemAccountId'] = 52326732;
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/payment/payanyway_ppay.tpl')) {
			$this->template = $this->config->get('config_template') . '/template/payment/payanyway_ppay.tpl';
		} else {
			$this->template = 'default/template/payment/payanyway_ppay.tpl';
		}	
