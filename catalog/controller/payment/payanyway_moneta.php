...
class ControllerPaymentPayanywayMoneta extends Controller {
	protected function index() {
		...
		$this->data['paymentSystemUnitId'] = 1015;
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/payment/payanyway_moneta.tpl')) {
			$this->template = $this->config->get('config_template') . '/template/payment/payanyway_moneta.tpl';
		} else {
			$this->template = 'default/template/payment/payanyway_moneta.tpl';
		}	
