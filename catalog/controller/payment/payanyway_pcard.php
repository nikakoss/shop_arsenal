...
class ControllerPaymentPayanywayPCard extends Controller {
	protected function index() {
		...
		$this->data['paymentSystemUnitId'] = 499669;
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/payment/payanyway_pcard.tpl')) {
			$this->template = $this->config->get('config_template') . '/template/payment/payanyway_pcard.tpl';
		} else {
			$this->template = 'default/template/payment/payanyway_pcard.tpl';
		}	
