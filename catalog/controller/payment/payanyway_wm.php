...
class ControllerPaymentPayanywayWM extends Controller {
	protected function index() {
		...
		$this->data['paymentSystemUnitId'] = 1017;
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/payment/payanyway_wm.tpl')) {
			$this->template = $this->config->get('config_template') . '/template/payment/payanyway_wm.tpl';
		} else {
			$this->template = 'default/template/payment/payanyway_wm.tpl';
		}	
