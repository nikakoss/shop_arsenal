...
class ControllerPaymentPayanywayCity extends Controller {
	protected function index() {
		...
		$this->data['paymentSystemUnitId'] = 426904;
		$this->data['paymentSystemAccountId'] = 152;
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/payment/payanyway_city.tpl')) {
			$this->template = $this->config->get('config_template') . '/template/payment/payanyway_city.tpl';
		} else {
			$this->template = 'default/template/payment/payanyway_city.tpl';
		}	
