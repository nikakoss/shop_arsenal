...
class ControllerPaymentPayanywayMKB extends Controller {
	protected function index() {
		...
		$this->data['paymentSystemUnitId'] = 295339;
		$this->data['paymentSystemAccountId'] = 143;
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/payment/payanyway_mkb.tpl')) {
			$this->template = $this->config->get('config_template') . '/template/payment/payanyway_mkb.tpl';
		} else {
			$this->template = 'default/template/payment/payanyway_mkb.tpl';
		}	
