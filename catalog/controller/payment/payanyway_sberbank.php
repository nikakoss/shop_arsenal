...
class ControllerPaymentPayanywaySberbank extends Controller {
	protected function index() {
		...
		$this->data['paymentSystemUnitId'] = 510801;
		$this->data['paymentSystemAccountId'] = 160;
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/payment/payanyway_sberbank.tpl')) {
			$this->template = $this->config->get('config_template') . '/template/payment/payanyway_sberbank.tpl';
		} else {
			$this->template = 'default/template/payment/payanyway_sberbank.tpl';
		}	
