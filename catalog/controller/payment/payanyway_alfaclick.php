...
class ControllerPaymentPayanywayAlfaclick extends Controller {
	protected function index() {
		...
		$this->data['paymentSystemUnitId'] = 587412;
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/payment/payanyway_alfaclick.tpl')) {
			$this->template = $this->config->get('config_template') . '/template/payment/payanyway_alfaclick.tpl';
		} else {
			$this->template = 'default/template/payment/payanyway_alfaclick.tpl';
		}	
