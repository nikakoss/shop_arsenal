...
class ControllerPaymentPayanywayPost extends Controller {
	protected function index() {
		...
		$this->data['paymentSystemUnitId'] = 1029;
		$this->data['paymentSystemAccountId'] = 15;
		...
		$this->data['entry_mailofrussiaSenderIndex'] = $this->language->get('entry_mailofrussiaSenderIndex');
		$this->data['entry_mailofrussiaSenderRegion'] = $this->language->get('entry_mailofrussiaSenderRegion');
		$this->data['entry_mailofrussiaSenderAddress'] = $this->language->get('entry_mailofrussiaSenderAddress');
		$this->data['entry_mailofrussiaSenderName'] = $this->language->get('entry_mailofrussiaSenderName');
		$this->data['entry_mailofrussiaError'] = $this->language->get('entry_mailofrussiaError');

		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/payment/payanyway_post.tpl')) {
			$this->template = $this->config->get('config_template') . '/template/payment/payanyway_post.tpl';
		} else {
			$this->template = 'default/template/payment/payanyway_post.tpl';
		}	
