...
class ControllerProductProduct extends Controller {
    ...
    public function index() {
        ...
        if ($product_info) {
            ...
            $this->document->setTitle(($product_info['seo_title'] ? $product_info['seo_title'] : $product_info['name']));
            ...
            $this->document->addScript('catalog/view/javascript/product_script.js');
            ...
            if ($product_info['quantity'] <= 0) {
                $this->data['stock'] = $this->language->get('text_instock2');
            ...
            foreach ($results as $items) {
                if ($items['product_id'] == $product_info['product_id']) {
                    $this->data['stiker'] = '<img src="catalog/view/image/new.png" alt="">';
                    break;
                } else {
                    $this->data['stiker'] = '';
                }
            ...
            if ($product_info['image']) {
                ...
                $this->data['small_thumb'] = $this->model_tool_image->resize($product_info['image'], $this->config->get('config_image_additional_width'), $this->config->get('config_image_additional_height'));
            } else {
                ...
                $this->data['small_thumb'] = $this->model_tool_image->resize('no_image.jpg', $this->config->get('config_image_additional_width'), $this->config->get('config_image_additional_height'));
            }
            ...
            if ($product_info['image'] && $results) {
                $this->data['images'][] = array(
                    'popup' => $this->data['popup'],
                    'thumb' => $this->data['thumb'],
                    'small_thumb' => $this->data['small_thumb']
                );
            }
            ...
            foreach ($results as $result) {
                $this->data['images'][] = array(
                    ...
                    'small_thumb' => $this->model_tool_image->resize($result['image'], $this->config->get('config_image_additional_width'), $this->config->get('config_image_additional_height')),
            ...
            $this->data['grade'] = html_entity_decode($product_info['grade'], ENT_QUOTES, 'UTF-8');
            $this->data['attribute_groups'] = $this->model_catalog_product->getProductAttributes($this->request->get['product_id']);

         $this->data['products_related'] = array();
         $getProductCategoryRelated = $this->model_catalog_product->getProductCategoryRelated($this->request->get['product_id']);
         foreach ($getProductCategoryRelated as $results){
            $this->data['products'] = array();
            foreach ($results['product_array'] as $result) {
                if ($result['image']) {
                    $image = $this->model_tool_image->resize($result['image'], 90, 90);
                } else {
                    $image = $this->model_tool_image->resize('data/no_image.jpg', 90, 90);
                }
            ...
            $this->data['products_related'][]=array(
                   ...
                   'name'=>$results['name'],
                   'product_array'=>$this->data['products']
            );
        }  
    ...
    public function review_rait_s() {
        ...
        if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/product/review.tpl')) {
            $this->template = $this->config->get('config_template') . '/template/product/rait_s.tpl';
        } else {
            $this->template = 'default/template/product/rait_s.tpl';
        }
