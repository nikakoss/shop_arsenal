...
// Heading
$_['heading_title'] = '';
$_['email_request_subject'] = 'Заявка с сайта kuvalda.net';
$_['user_name']             = 'Имя:';
...
$_['text_success']          = 'Наши менеджеры скоро с Вами свяжутся.';
...
$_['error_user_phone']        = '<div class="not"><div class="left"></div><div class="center">Телефон должен состоять только из цифр. от 4х до 11</div><div class="right"></div></div>';
?>